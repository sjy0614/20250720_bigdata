...
@st.cache_data
def load_data():
    df_train = pd.read_excel(r"C:\Users\송주용\Desktop\기업체주관 빅데이터 분석\최종_태양광.xlsx", sheet_name='Sheet1')
    df_idle = pd.read_excel(r"C:\Users\송주용\Desktop\기업체주관 빅데이터 분석\유휴부지_월별_날씨포함.xlsx", sheet_name='Sheet1')
